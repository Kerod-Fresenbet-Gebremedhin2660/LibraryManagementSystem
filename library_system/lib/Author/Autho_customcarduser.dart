...
class Authusercontent extends StatefulWidget {
  static const routeName = '/';
  @override
  _AuthuserContentState createState() => _AuthuserContentState();
}

class _AuthuserContentState extends State<Authusercontent> {
  ...
  Widget build(context) {
    ...
    return Scaffold(body: BlocBuilder<AuthorBloc, AuthorState>(
      builder: (_, state) {
