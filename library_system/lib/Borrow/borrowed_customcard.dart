...
class BorrowedContent extends StatefulWidget {
  Book book;
  @override
  _ContentState createState() => _ContentState();
}

class _ContentState extends State<BorrowedContent> {
        ...
        if (state is BookLoadSuccess) {
              ...
              itemBuilder: (_, index) =>Container(
                        child: InkWell(
                          onTap: (){
                            ...
                            context,
                            MaterialPageRoute(
                                builder: (context) => BorrowedDetail(
                                      book:books[index],
                                    )));
                          },
                          child: Card(
          ...
          /*ListView.builder(
              ...
              itemBuilder: (_, idx) => ListTile(
                    title: _customcard('${books[idx].bookTitle}'),
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
